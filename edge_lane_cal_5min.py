...
import pandas as pd
def cal_edge_lane_5min(file1,file2,file5,tag):
    tree = ET.parse(file1)
        ...
        for edge in node:
            ...
            for lane in edge:
                try:
                    ...
                    l_id = lane.attrib["id"]
                    l_dep = lane.attrib["departed"]
                    l_arrived = lane.attrib["arrived"]
                    l_entered = lane.attrib["entered"]
                    l_left = lane.attrib["left"]
                    l_laneChangedFrom = lane.attrib["laneChangedFrom"]
                    l_laneChangedTo = lane.attrib["laneChangedTo"]
                    lane_id.append(l_id)
    ...
    # print(simulation_all_lane_df)
        ...
        for i in range(len(lane_id_veh)):
            q = round(float(speed_veh[i]) * 3.6 * float(lane_density_veh[i]))
        ...
        file3 = "./output/output_" + tag + "/simulation_veh_lane_" + tag + "_5min" + "_" + str(cycle_times) +".csv"
        ...
        file4 = "./output/output_" + tag + "/simulation_veh_link_" + tag + "_5min" + "_" + str(cycle_times) +".csv"
        simulation_veh_link_df.to_csv(file4)
        cycle_times += 1

# file1 = r'..\0525\output\background\output.lanedata.xml'
# file2 = r'..\0525\output\background\osm.net.xml'
# file3 = r'simulation_veh_lane_background.csv'
# file4 = r'simulation_veh_link_background.csv'
# file5 = r'E:\output_convert_xy\tiquluwangzuobiao\0616\dss_project_link.csv'
# file6 = r'..\0525\output\new_built\output.lanedata.xml'
# file7 = r'..\0525\output\new_built\osm.net.xml'
# file8 = r'simulation_veh_lane_new.csv'
# file9 = r'simulation_veh_link_new.csv'
# cal_edge_lane(file1,file2,file3,file4,file5)
# cal_edge_lane(file6,file7,file8,file9,file5)

# file1 = r'E:\output_convert_xy\output_huizong\0617\output.lanedata.xml'
# file2 = r'E:\output_convert_xy\output_huizong\0617\osm.net.xml'
# # file3 = "simulation_veh_lane_background.csv"
# # file4 = "simulation_veh_link_background.csv"
# file5 = r'E:\output_convert_xy\output_huizong\0617\dss_project_link.csv'

# cal_edge_lane_5min(file1,file2,file5)