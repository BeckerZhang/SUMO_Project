...
def cal_junc(file1,file2,file3,file4,file5,file6,file7,file8):
...
# cal_junc(r'osm.net.xml',r'simulation_veh_lane.csv',r'交叉口进口道方位_new.csv',r'交叉口分组结果.csv',r'交叉口计算结果.csv',r'交叉口出口道方位_new.csv',r'junction_result_new.csv',r'in.json')